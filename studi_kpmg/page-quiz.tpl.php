...
<html xmlns:fb="http://www.facebook.com/2008/fbml" xmlns:og="http://ogp.me/ns#" xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php print $language->language; ?>" lang="<?php print $language->language; ?>" dir="<?php print $language->dir; ?>">

<head>
  <title><?php print $head_title; ?></title>
  <meta name="author" content="Studizone.ch GmbH" />
  <meta name="robots" content="index, follow" />
  <meta name="google-site-verification" content="ZH6GWS9x87vpQwnrfAXSWIalM9z87MoRDhwgqWV6fJI" />
  ...
  <script type="text/javascript">
   ...
   $(par1).triggerHandler("click");
   });
   </script>
  <script type="text/javascript"> var siteBaseURL = '<?php print $base_url; ?>'; </script>
</head>
<body class="<?php print 'logged-user-' . $user->uid . ' ' . $classes; ?>">
  ...
  <div id="page-wrapper"><div id="page">
    ...
    <div id="studi-header-bg"><div id="header"><div class="section clearfix">
	...
	<div id="studi-color-bar"></div><!-- /.section, /#header -->
